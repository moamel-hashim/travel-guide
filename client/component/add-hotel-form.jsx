            ...
            <div className="row">
              ...
              <div className='input-container w-50 mt-4'>
                ...
                <div className='row ms-1'>
                  ...
                  <input type="text" name='state' id='state' className=' mt-3 mb-3 p-2 input-design-state' placeholder='state'
                    required
                    onChange={this.handleChange} value={this.state.state} />
                  <input type="text" name='zipCode' id='zip-code' className=' mb-3 p-2 input-design-zip mt-3' placeholder='zip code'
                    required
